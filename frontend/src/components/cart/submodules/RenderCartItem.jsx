...
import { Box, Button, ButtonBase, List, ListItem, styled, Typography, useTheme } from '@mui/material';
        ...
        <Box id='cart-item-container' sx={{
            ...
            <Box id='item-buttons' sx={{
                ...
                <Box id='quantity-controls' sx={{
                    ...
                    }} disabled={product.quantity >= products?.find((item) => product.product === item._id)?.stock || 0}>
                        +
                    </QuantityButton>
                    <Typography fontSize='14px' color={`hsl(from ${theme.palette.primary.submain} h s calc(l*1.75))`}>
                        {product.quantity}
                    </Typography>
                    <QuantityButton onClick={() => {
                        updateQuantity(product.product, product.size, product.quantity - 1)
                ...
                <Button id='delete-item' component='button' sx={{
                    background: 'none',
                    border: 'none',
